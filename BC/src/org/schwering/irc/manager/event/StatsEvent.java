...
public class StatsEvent {
    ...
    private String cLineHost, cLineName, cLineClass;
    int cLinePort;
    private String nLineHost, nLineName, nLineClass;
    int nLinePort;
    private String iLineHost, iLineHost2, iLineClass;
    int iLinePort;
    private String kLineHost, kLineUsername, kLineClass;
    int kLinePort;
    private String lLineHostmask, lLineServername;
    int lLineMaxDepth;
    private String yLineClass;
    int yLinePingFrequency, yLineConnectionFrequency, yLineMaxQueuedSendData;
