...
// ------------------------------
	...
	private static SSLSocketFactory createJava14SSLSocketFactory(SSLTrustManager[] tm)
        ...
        Class<? extends Object> keyManagerArrayClass = java.lang.reflect.Array.newInstance(keyManagerClass, 0).getClass();
        Class<?> trustManagerClass = Class.forName("javax.net.ssl.TrustManager");
        Class<? extends Object> trustManagerArrayClass = java.lang.reflect.Array.newInstance(trustManagerClass, 0).getClass();
        Class<SecureRandom> secureRandomClass = java.security.SecureRandom.class;
