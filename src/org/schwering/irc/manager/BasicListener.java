...
class BasicListener implements IRCEventListener {
    ...
    private NumericEventChain banlistChain = new NumericEventChain(
        ...
        class Banlist {
            ...
            Banlist(String id) {
                channel = owner.resolveChannel(id);
            }
        }
    ...
    private NumericEventChain statsChain = new NumericEventChain(
        ...
        class Stats {
            String linkName;
            int sendQ, sentM, sentB, recvM, recvB;
            long millisOpen;
            Map commandMap = new TreeMap();
            String uptime;
            String clineHost, clineName, clineClass;
            int clinePort;
            String nlineHost, nlineName, nlineClass;
            int nlinePort;
            String ilineHost, ilineHost2, ilineClass;
            int ilinePort;
            String klineHost, klineUserName, klineClass;
            int klinePort;
            String llineHostMask, llineServerName;
            int llineMaxDepth;
            String ylineClass;
            int ylinePingFreq, ylineConnectFreq, ylineMaxSendQ;
